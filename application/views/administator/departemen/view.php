    <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Kelola Data Departemen</h1>
            </div>
            <?php
            ...
            <div class="col-xl-6">
                <div class="ibox">
                    <div class="ibox-head">
                    <div class="ibox-title">Data Departemen<a href="<?= base_url('administator/KelolaDepartemen/tambah'); ?>">
                               ...
                               <?php
                                ...
                                foreach ($departemen as $row) { ?>
                                    <tr>
                                        ...
                                        <td>
                                        <div class="btn-group">
                                        <a href="<?= base_url() ?>administator/KelolaDepartemen/ubah/<?= $row->departemen_id ?>" class="mr-2">
                                        ...
                                        <a href="<?= base_url() ?>administator/KelolaDepartemen/hapus/<?= $row->departemen_id ?>" class="mr-2" onclick="return confirm('yakin ?')">
