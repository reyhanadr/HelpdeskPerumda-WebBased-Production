<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            ...
            <div class="ibox-body">
                <form class="form-horizontal" action="<?php echo site_url('teknisi/KelolaRequest/simpanRequest/'); ?>"
                    method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Request ID</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="request_id_tampil"
                                value="<?php echo $newReqID ?>" disabled>
                            <input class="form-control" type="text" name="request_id" value="<?php echo $newReqID ?>"
                                hidden>
                            <input class="form-control" type="text" name="user_id" value="<?php echo $users->user_id ?>"
                                hidden>
                            <input class="form-control" type="text" name="role_id" value="<?php echo $users->role_id ?>"
                                hidden>
                            <input class="form-control" type="text" name="department_id"
                                value="<?php echo $users->departemen_id ?>" hidden>
                    ...
                    <div class="form-group row" id="date_1">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group date">
                                ...
                                <input class="form-control" type="text" name="" value="<?php echo $tanggalHariIni ?>"
                                    readonly>
                            </div>
                        </div>
                    </div>
