                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form class="form-horizontal"
                            action="<?php echo site_url('teknisi/KelolaPerangkat/simpanPerangkat'); ?>" method="post"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="penanggungjawab"
                                        value="<?php echo $users->nama ?>" disabled>
                                    <input class="form-control" type="text" name="user_id"
                                        value="<?php echo $users->user_id ?>" hidden>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="lokasi_fisik"
                                        value="<?php echo $users->nama_departemen ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Status Perangkat</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="status_perangkat_tampil" disabled
                                        value="RUNNING" required>
                                    <input class="form-control" type="text" name="status_perangkat" hidden
                                        value="RUNNING" required>
                                </div>
                            </div>
                            <div class="form-group row">
