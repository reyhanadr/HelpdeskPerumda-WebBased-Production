            ...
            <div class="col-lg-4">
                <div class="ibox">
                                    ...
                                    <div class="media-body">
                                        <div class="media-heading">
                                            ...
                                            <?php if ($item->status_perangkat == 'PENDING'): ?>
                                                <span class="font-16 float-right badge badge-warning">
                                                    <?php echo $item->status_perangkat; ?>
                                                </span>
                                            <?php elseif ($item->status_perangkat == 'FIXED'): ?>
                                                <span class="font-16 float-right badge badge-success">
                                                    <?php echo $item->status_perangkat; ?>
                                                </span>
                                            ...
                                            <?php else: ?>
                                                <span class="font-16 float-right badge badge-danger">
                                                    <?php echo $item->status_perangkat; ?>
                                                </span>
                                            <?php endif; ?>
                                        </div>
                    ...
                    <div class="ibox-footer text-center">
                        <a href="<?= base_url() ?>index.php/Teknisi/KelolaPerangkat">Lihat Semua Perangkat</a>
                    </div>
                </div>
            </div>
        </div>
